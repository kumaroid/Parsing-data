...
def get_wall_posts(access_token):
    user_id = get_user_id(access_token)
    params = {
        'access_token': access_token,
        'owner_id': user_id,
...
def count_likes_and_comments(access_token):
    wall_posts = get_wall_posts(access_token)
    likes_count = 0
    comments_count = 0
...
for friend in top_active_friends:
    ...
    likes_count, comments_count = count_likes_and_comments(access_token)
